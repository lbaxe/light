...
public class AsyncService extends ProxyProcessorSupport {
     ...
     * 切点顾问
     */
    public class BeanPointcutAdvisor extends AbstractPointcutAdvisor {
        // 通知-拦截器
        private Advice advice;
        // 切点-拦截规则
        private Pointcut pointcut;

        public BeanPointcutAdvisor() {
            advice = new AsyncExecutionInterceptor(null);
            pointcut = new BeanPointcut();
        }
