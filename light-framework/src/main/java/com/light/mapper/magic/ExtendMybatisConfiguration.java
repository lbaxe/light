 ...
 * @since 2016-01-23
 */
public class ExtendMybatisConfiguration extends MybatisConfiguration {
    private static final Log logger = LogFactory.getLog(ExtendMybatisConfiguration.class);
    /**
     * Mapper 注册
     */
    protected final ExtendMybatisMapperRegistry extendMybatisMapperRegistry = new ExtendMybatisMapperRegistry(this);
    ...
    public ExtendMybatisConfiguration(Environment environment) {
        this();
     ...
     * 初始化调用
     */
    public ExtendMybatisConfiguration() {
        super();
     ...
     */
    @Override
    public ExtendMybatisMapperRegistry getMapperRegistry() {
        return extendMybatisMapperRegistry;
    }
    ...
    public <T> void addMapper(Class<T> type) {
        extendMybatisMapperRegistry.addMapper(type);
    }
    ...
    public void addMappers(String packageName, Class<?> superType) {
        extendMybatisMapperRegistry.addMappers(packageName, superType);
    }
    ...
    public void addMappers(String packageName) {
        extendMybatisMapperRegistry.addMappers(packageName);
    }
    ...
    public <T> T getMapper(Class<T> type, SqlSession sqlSession) {
        return extendMybatisMapperRegistry.getMapper(type, sqlSession);
    }
    ...
    public boolean hasMapper(Class<?> type) {
        return extendMybatisMapperRegistry.hasMapper(type);
    }
