 ...
 * @since 2018-04-06
 */
public class SelectPKListByMap extends ExtendAbstractMethod {

    @Override
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ExtendSqlMethod sqlMethod = ExtendSqlMethod.SELECT_PK_LIST_BY_MAP;
        String sql = String.format(sqlMethod.getSql(), tableInfo.getKeyColumn(), tableInfo.getTableName(),
