 ...
 * @since 2018-06-09
 */
public class ExtendMybatisMapperProxy<T> implements InvocationHandler, Serializable {
    ...
    public ExtendMybatisMapperProxy(SqlSession sqlSession, Class<T> mapperInterface,
            ...
            return CollectionUtils.computeIfAbsent(methodCache, method, m -> {
                if (m.isDefault()) {
                    ...
                    return new PlainMethodInvoker(
                        new ExtendMybatisMapperMethod(mapperInterface, method, sqlSession.getConfiguration()));
                }
            });
    ...
    private static class PlainMethodInvoker implements MapperMethodInvoker {
        private final ExtendMybatisMapperMethod mapperMethod;

        public PlainMethodInvoker(ExtendMybatisMapperMethod mapperMethod) {
            super();
